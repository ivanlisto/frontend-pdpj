...
export class TelaConsultaComponent implements OnInit {
    ...
    public popularDossie(dossie) {
      console.log('dossie:', dossie.content);
      for (const d of dossie.content) {
        this.listDossie.push(d);
      }
      this.listDossie.push(dossie.content);
      console.log('teste', this.listDossie);
